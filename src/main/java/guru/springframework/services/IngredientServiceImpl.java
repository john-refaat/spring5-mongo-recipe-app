...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientServiceImpl(IngredientToIngredientCommand ingredientToIngredientCommand,
                                 ...
                                 RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, RecipeReactiveRepository recipeReactiveRepository, UnitOfMeasureReactiveRepository unitOfMeasureReactiveRepository) {
    ...
    public Mono<IngredientCommand> saveIngredientCommand(IngredientCommand command) {
        ...
        if(!recipeOptional.isPresent()){
            ...
            Mono<IngredientCommand> savedIngridMono = recipeReactiveRepository.save(recipe).flatMapIterable(Recipe::getIngredients)
                    .filter(recipeIngredients -> recipeIngredients.getId().equals(command.getId()))
                    .map(ingredientToIngredientCommand::convert).doOnNext(c -> c.setRecipeId(command.getRecipeId())).next();
            log.info("Saved Ingredient "+command);
